...
void setUpSimObjects()
{
	...
	hr = SimConnect_AICreateSimulatedObject(hSimConnect, "yz10", Init, REQUEST_RIGHTFOREARM);
	hr = SimConnect_AICreateSimulatedObject(hSimConnect, "yz10", Init, REQUEST_RIGHTHAND);
	hr = SimConnect_AICreateSimulatedObject(hSimConnect, "yz10", Init, REQUEST_LEFTSHOULDER);
	hr = SimConnect_AICreateSimulatedObject(hSimConnect, "yz10", Init, REQUEST_LEFTFOREARM);
	hr = SimConnect_AICreateSimulatedObject(hSimConnect, "yz10", Init, REQUEST_LEFTHAND);
	...
	hr = SimConnect_AICreateSimulatedObject(hSimConnect, "yz10", Init, REQUEST_RIGHTARM);
	hr = SimConnect_AICreateSimulatedObject(hSimConnect, "yz10", Init, REQUEST_LEFTARM);
...
void releaseBone()
{
	...
	SimConnect_ReleaseSimObjectFromSimObject(hSimConnect, BoneList[38].ID, BoneList[39].ID);
	SimConnect_ReleaseSimObjectFromSimObject(hSimConnect, BoneList[37].ID, BoneList[38].ID);
	SimConnect_ReleaseSimObjectFromSimObject(hSimConnect, BoneList[36].ID, BoneList[37].ID);
	
	SimConnect_ReleaseSimObjectFromSimObject(hSimConnect, BoneList[11].ID, BoneList[36].ID);


	SimConnect_ReleaseSimObjectFromSimObject(hSimConnect, BoneList[15].ID, BoneList[16].ID);
	SimConnect_ReleaseSimObjectFromSimObject(hSimConnect, BoneList[14].ID, BoneList[15].ID);
	SimConnect_ReleaseSimObjectFromSimObject(hSimConnect, BoneList[13].ID, BoneList[14].ID);
	
	SimConnect_ReleaseSimObjectFromSimObject(hSimConnect, BoneList[11].ID, BoneList[13].ID);
	*/
	
	SimConnect_ReleaseSimObjectFromSimObject(hSimConnect, BoneList[11].ID, BoneList[12].ID);
	
	SimConnect_ReleaseSimObjectFromSimObject(hSimConnect, BoneList[10].ID, BoneList[11].ID);
	
	SimConnect_ReleaseSimObjectFromSimObject(hSimConnect, BoneList[9].ID, BoneList[10].ID);
	
	SimConnect_ReleaseSimObjectFromSimObject(hSimConnect, BoneList[8].ID, BoneList[9].ID);
	SimConnect_ReleaseSimObjectFromSimObject(hSimConnect, BoneList[7].ID, BoneList[8].ID);
...
void attachBone()
{
	...
	SimConnect_AttachSimObjectToSimObject(hSimConnect, BoneList[0].ID, BoneList[7].attachxyz[0], BoneList[7].attachpbh[0], BoneList[7].ID, BoneList[7].attachxyz[1], BoneList[8].attachpbh[1]);
	SimConnect_AttachSimObjectToSimObject(hSimConnect, BoneList[7].ID, BoneList[8].attachxyz[0], BoneList[8].attachpbh[0], BoneList[8].ID, BoneList[8].attachxyz[1], BoneList[9].attachpbh[1]);
	SimConnect_AttachSimObjectToSimObject(hSimConnect, BoneList[8].ID, BoneList[9].attachxyz[0], BoneList[9].attachpbh[0], BoneList[9].ID, BoneList[9].attachxyz[1], BoneList[10].attachpbh[1]);
	
	SimConnect_AttachSimObjectToSimObject(hSimConnect, BoneList[9].ID, BoneList[10].attachxyz[0], BoneList[10].attachpbh[0], BoneList[10].ID, BoneList[10].attachxyz[1], BoneList[11].attachpbh[1]);
	
	SimConnect_AttachSimObjectToSimObject(hSimConnect, BoneList[10].ID, BoneList[11].attachxyz[0], BoneList[11].attachpbh[0], BoneList[11].ID, BoneList[11].attachxyz[1], BoneList[12].attachpbh[1]);
	
	SimConnect_AttachSimObjectToSimObject(hSimConnect, BoneList[11].ID, BoneList[12].attachxyz[0], BoneList[12].attachpbh[0], BoneList[12].ID, BoneList[12].attachxyz[1], BoneList[12].attachpbh[0]);//key bodyover
	
	SimConnect_AttachSimObjectToSimObject(hSimConnect, BoneList[11].ID, BoneList[13].attachxyz[0], BoneList[13].attachpbh[0], BoneList[13].ID, BoneList[13].attachxyz[1], BoneList[14].attachpbh[1]);
	
	SimConnect_AttachSimObjectToSimObject(hSimConnect, BoneList[13].ID, BoneList[14].attachxyz[0], BoneList[14].attachpbh[0], BoneList[14].ID, BoneList[14].attachxyz[1], BoneList[15].attachpbh[1]);
	/*
	SimConnect_AttachSimObjectToSimObject(hSimConnect, BoneList[14].ID, BoneList[15].attachxyz[0], BoneList[15].attachpbh[0], BoneList[15].ID, BoneList[15].attachxyz[1], BoneList[16].attachpbh[1]);
	
	SimConnect_AttachSimObjectToSimObject(hSimConnect, BoneList[15].ID, BoneList[16].attachxyz[0], BoneList[16].attachpbh[0], BoneList[16].ID, BoneList[16].attachxyz[1], BoneList[16].attachpbh[0]);//key righthandover

	SimConnect_AttachSimObjectToSimObject(hSimConnect, BoneList[11].ID, BoneList[36].attachxyz[0], BoneList[36].attachpbh[0], BoneList[36].ID, BoneList[36].attachxyz[1], BoneList[37].attachpbh[1]);
	
	SimConnect_AttachSimObjectToSimObject(hSimConnect, BoneList[36].ID, BoneList[37].attachxyz[0], BoneList[37].attachpbh[0], BoneList[37].ID, BoneList[37].attachxyz[1], BoneList[38].attachpbh[1]);
	
	SimConnect_AttachSimObjectToSimObject(hSimConnect, BoneList[37].ID, BoneList[38].attachxyz[0], BoneList[38].attachpbh[0], BoneList[38].ID, BoneList[38].attachxyz[1], BoneList[39].attachpbh[1]);
	
	SimConnect_AttachSimObjectToSimObject(hSimConnect, BoneList[38].ID, BoneList[39].attachxyz[0], BoneList[39].attachpbh[0], BoneList[39].ID, BoneList[39].attachxyz[1], BoneList[39].attachpbh[0]);//key righthandover
	*/
