...
namespace P3D
{
    ...
    /**
     * Base plugin implimentation.  This class registers for common Prepar3D events and messages,
    ...
    protected:
        ...
        public:
            ...
            DEFAULT_IUNKNOWN_QI_INLINE_IMPL(P3dPluginCallback, IID_ICallbackV400)
        };
       /** 
