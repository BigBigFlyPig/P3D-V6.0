///----------------------------------------------------------------------------
///
///  Copyright (C) Lockheed Martin Corporation 2014
///  All rights reserved
///  
...
public:
    ...
    // **** IGaugeCCallback Methods Not being used by this implimentation ****
...
{}
 ...
 {
     // if this gauge callback was responsable for initializing the radar then
...
bool RadarGaugeCallback::Serialize(NetOutPublic& netout)
{
    ...
    // this is just a safe gaurd in case other plug-ins use the radar.  Future versions of the radar
